...
export const metadata: Metadata = {
  title: pageOg('/initiatives/opportunities/internships').title,
  description: 'Internship opportunities for African youth, curated by Top100 Africa Future Leaders.',
  ...ogMetadata(pageOg('/initiatives/opportunities/internships'), { url: '/initiatives/opportunities/internships' }),
};
