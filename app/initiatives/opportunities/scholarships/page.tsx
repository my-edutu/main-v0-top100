...
export const metadata: Metadata = {
  title: pageOg('/initiatives/opportunities/scholarships').title,
  description: 'Scholarship opportunities for African youth, curated by Top100 Africa Future Leaders.',
  ...ogMetadata(pageOg('/initiatives/opportunities/scholarships'), { url: '/initiatives/opportunities/scholarships' }),
};
          ...
          <section className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-12">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a href="mailto:partnership@top100afl.com?subject=Scholarships%20Opportunity%20Inquiry&body=Hello%2C%0A%0AI%20would%20love%20to%20get%20more%20information%20on%20the%20Scholarships%20plan.%0A%0AThank%20you." className="bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-3 px-6 rounded-lg transition duration-300">
                  Contact Us
                </a>
              </div>
            </div>
