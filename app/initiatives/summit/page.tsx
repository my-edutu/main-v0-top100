    ...
    <div className="bg-black text-white">
      ...
      <main className="container mx-auto space-y-10 px-4 py-8 lg:px-8">
        ...
        <section className="rounded-3xl border border-orange-400/20 bg-gradient-to-r from-orange-500/30 via-orange-500/10 to-transparent p-10 text-center shadow-lg">
          ...
          <p className="mt-3 text-sm font-semibold uppercase tracking-widest text-orange-200">
            Registration is not open yet — dates and venue in Lagos to be announced.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Button asChild className="rounded-xl bg-white text-slate-900 hover:bg-slate-100">
              <Link href="/waitlist?program=summit-2026">Join the Waiting List</Link>
            </Button>
            <Button
              asChild
              variant="outline"
