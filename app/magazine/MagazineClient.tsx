                        ...
                        >
                            ...
                            <div className="p-5 space-y-4">
                                ...
                                <div className="flex gap-2 pt-2">
                                    <button
                                        onClick={() => handleDownloadClick(magazine)}
                                        className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-bold uppercase tracking-wider transition-colors rounded-lg bg-orange-500 hover:bg-orange-600 text-white cursor-pointer"
                                    >
