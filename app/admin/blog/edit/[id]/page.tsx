...
export default function EditPostPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-8 pb-28">
      <section className="relative overflow-hidden rounded-3xl border border-orange-100 bg-gradient-to-br from-orange-50 via-amber-50/60 to-white p-6 sm:p-8 shadow-sm">
        <div className="relative flex flex-col gap-6">
          <div className="flex flex-col-reverse gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-orange-500">Edit Story</p>
              <h1 className="mt-2 text-3xl font-black tracking-tight text-zinc-900 md:text-4xl">Update spotlight</h1>
      ...
      <form id="blog-edit-form" onSubmit={handleSubmit(onSubmit)} className="grid gap-6 lg:gap-8 lg:grid-cols-[minmax(0,1fr)_340px]">
          ...
          <Card className="border-zinc-200 shadow-sm rounded-2xl">
            <CardContent className="space-y-4 p-5 sm:p-6">
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-zinc-400">Used for the public URL.</p>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  {...register("tags")}
                />
                <p className="text-xs text-zinc-400">Comma separated keywords.</p>
              </div>
            </CardContent>
          </Card>
