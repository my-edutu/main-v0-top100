  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Import applicants, verify private PDF evidence, process 100 applications per batch, review decisions, freeze rankings, and publish explainable results."
        actions={
