        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <h3 className="text-lg font-semibold mb-4 mt-6">Information</h3>
              <ul className="space-y-2">
            ...
            <div>
              ...
              <div className="mt-6">
                <h4 className="text-xs font-semibold uppercase tracking-[0.32em] text-white mb-3">Let&apos;s collaborate</h4>
                ...
                <Button
                  ...
                  className="flex w-full items-center justify-center gap-1 rounded-xl text-xs border-white/40 text-white hover:bg-white/10 hover:text-white/90 mt-4"
                >
                  {mounted ? (
