...
export default function SpeakerCard({
  ...
  return (
    <Link
      ...
      className="group block snap-start rounded-[1.65rem] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-4"
    >
