...
export function buildVariantPrompt(tailoring: PortfolioEditInput['tailoring']) {
  ...
  return [
    ...
    'Treat the supplied portrait as the identity source of truth. Keep the person unmistakably recognizable: preserve their exact facial structure, proportions, skin tone, hairline, age, eyewear, gender presentation, and distinctive features. Never beautify, reshape, smooth, regenerate, or substitute the face; do not invent a lookalike. Only correct lighting and the pose needed for a forward-facing portrait.',
